    ...
    <div class="table-wrapper">
        <div class="table-title">
            <div class="row">
                ...
                <div class="col-sm-6">
                    <a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Request Approval</span></a>
                </div>
            </div>
        </div>
        <table class="table table-striped table-hover">
            <thead>
                <tr>
                    <th>ተ.ቁ</th>
                    <th>የሥራ ክፍል </th>
                    <th>የዩኒቨርሲቲው አስተዳደር</th>
                    <th>ዋናው ግቢ</th>
                    <th>ቢዝነስና ኢኮኖሚክስ</th>
                    <th>ኢንጅነሪንግግ BiT</th>
                    <th>ኢንጅነሪንግግ EITEX</th>
                    <th>ይባብ ግቢ</th>
                    <th>ዘንዘልማ ግቢ</th>
                    <th>ሕክምና እና ጤና ሳይንስ</th>
                    <th>ማሪታይም ግቢ</th>
                    <th>Actions</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    <td class="cell">1</td>
                    <td class="cell">የመምህሩ የቅርብ ኃላፊ</td>
                    <td class="cell approved">Approved</td>
                    <td class="cell approved">Approved</td>
                    <td class="cell approved">Approved</td>
                    <td class="cell approved">Approved</td>
                    <td class="cell approved">Approved</td>
                    ...
                    <td class="cell approved">Approved</td>
                    <td class="cell approved">Approved</td>
                    <td class="cell generate"><button >Generate</button><a href="#deleteEmployeeModal" class="delete" data-toggle="modal" data-id=" si->id "><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a> </td>
                    <!-- <a href="#editEmployeeModal" class="edit" data-toggle="modal" data-id="si->id "><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a> -->
